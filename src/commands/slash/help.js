...
exports.run = async function(client, con, interaction, data) {
    ...
    if(!cmd) {
            ...
            new client.discord.MessageSelectMenu()
                ...
                .addOptions([
                    ...
                    },
                    {
                        ...
                        description: 'View the owner commands for this bot!',
                        value: '2',
                    },
                    {
                        label: '📜 Credits',
        ...
        .setDescription(client.config.aboutServer || 'This is a multi-purpose ban database bot that is designed to protect your server and other communities!' || '📜')
